...
def init_db():
    ...
    # 3. movies (multi-part qo'llab quvvatlash bilan)
    cursor.execute("""
    ...
    cursor.execute("INSERT OR IGNORE INTO bot_version (id, version, changelog, updated_at) VALUES (1, 'v2.0', 'Tizim toliq qayta ishlandi', datetime('now'))")
...
def add_user(user_id: int, username: str, full_name: str):
    ...
    c.execute("INSERT OR IGNORE INTO users (id, username, full_name, join_date) VALUES (?, ?, ?, ?)",
